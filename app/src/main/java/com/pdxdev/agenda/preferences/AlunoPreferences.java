package com.pdxdev.agenda.preferences;

import android.content.Context;
import android.content.SharedPreferences;

/**
 * Created by allysson on 15/06/17.
 */

public class AlunoPreferences {
    private static final String ALUNO_PREFERENCES = "com.pdxdev.agenda.preferences.AlunoPreferences";
